    ...
    <div id="about" class="about_wrap">
        <div class="about_title">
            <section class="left_side">
                <svg
                    id="aboutSvg"
                    style="enable-background: new 0 0 706.5 207.4"
                >
            ...
            <section class="right_side">
                    ...
                    <div class="inner">
                        ...
                        <div class="my">
                            ...
                            <div class="modal_cont">
                                ...
                                <div class="icon_wrap">
                                    <a
                                        href="https://github.com/sott120"
                                        target="_blank"
                                    >
                                        <img
                                            src="../static/img/icon/github_white.svg"
                                        />
                                    </a>
                                    <a
                                        href="https://sott120.tistory.com/"
                                        target="_blank"
                                    >
                                        <img
                                            src="../static/img/icon/tistory.svg"
                                        />
                                    </a>
                ...
                <article class="iam ml_122">
                    <div class="title eng mb_50">
                        <h2>I am</h2>
                        <span @click="[(modal = true), noScroll()]">
                            more info
                            <img
                                src="../static/img/icon/plus.png"
                                alt="더보기버튼"
                            />
                        </span>
                    </div>
                    ...
                    <div class="main_skill">
                        ...
                        <ul class="skills_cont mb_100 eng">
                            ...
                            <li>
                                <div class="skill_L">
                                    <img
                                        src="../static/img/icon/javascript.svg"
                                        height="30px"
                                    />
                            ...
                            <li>
                                <div class="skill_L">
                                    <img
                                        src="../static/img/icon/typescript.svg"
                                        height="29px"
                                    />
                            ...
                            <li>
                                <div class="skill_L">
                                    <img
                                        src="../static/img/icon/nodejs.svg"
                                        height="29px"
                                    />
                                    <span>Node.js</span>
                                </div>
                            ...
                            <li>
                                <div class="skill_L">
                                    <img
                                        src="../static/img/icon/database.svg"
                                        height="29px"
                                    />
                                    <span>MySQL</span>
                                </div>
                    ...
                    <div class="other_skill">
                        ...
                        <ul class="skill_others eng">
                            <li>
                                ...
                                <ul class="skills_cont mb_100 eng">
                                    <li>
                                        <div class="skill_L">
                                            <img
                                                src="../static/img/icon/bootstrap.svg"
                                                height="20px"
                                            />
                                            <span>Bootstrap</span>
                                        </div>
                                    ...
                                    <li>
                                        <div class="skill_L">
                                            <img
                                                src="../static/img/icon/heroku.svg"
                                                height="25px"
                                            />
                                            <span>Heroku</span>
                                        </div>
                                    ...
                                    <li>
                                        <div class="skill_L">
                                            <img
                                                src="../static/img/icon/firebase.svg"
                                                height="25px"
                                            />
                                            <span>Firebase</span>
                                        </div>
                            ...
                            <li>
                                ...
                                <p>Power point, <em>한글</em>, word, Excel</p>
                            </li>
                        </ul>
                    </div>
                </article>
